...
dev.new()
with(hpcDataFinal,plot(dateAndTime,Global_active_power,type="l",col="black",xlab="",ylab="Global Active Power (kilowatts)"))
dev.copy(png,"./EDA-P1/plot2.png",width = 480, height = 480)
dev.off()
...
legend("topright",legend=plotLabels,col = colors,lty = "solid")
dev.copy(png,"./EDA-P1/plot3.png",width = 480, height = 480)
dev.off()
